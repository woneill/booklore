...
class MobileSeriesServiceTest {
    ...
    private MobileSeriesService service;

    private final Long userId = 1L;

    @BeforeEach
    void setUp() {
        service = new MobileSeriesService(
    ...
    class GetSeriesTests {
        ...
        void getSeries_admin_noParams_returnsPage() {
            ...
            MobilePageResponse<MobileSeriesSummary> result = service.getSeries(0, 20, null, null, null, null, false);
        ...
        void getSeries_nonAdmin_withAccessibleLibrary_succeeds() {
            ...
            MobilePageResponse<MobileSeriesSummary> result = service.getSeries(0, 20, null, null, 5L, null, false);
        ...
        void getSeries_withSearch_passesSearchPattern() {
            ...
            MobilePageResponse<MobileSeriesSummary> result = service.getSeries(0, 20, null, null, null, "harry", false);
        ...
        void getSeries_inProgressOnly_returnsFilteredResults() {
            ...
            MobilePageResponse<MobileSeriesSummary> result = service.getSeries(0, 20, null, null, null, null, true);
        ...
        void getSeries_paginationDefaults_appliedCorrectly() {
            ...
            MobilePageResponse<MobileSeriesSummary> result = service.getSeries(null, null, null, null, null, null, false);
        ...
        void getSeries_pageSizeCapped_atMax() {
            ...
            MobilePageResponse<MobileSeriesSummary> result = service.getSeries(0, 100, null, null, null, null, false);
        ...
        void getSeries_enrichesCoverBooksAndAuthors() {
            ...
            MobileSeriesSummary series = result.getContent().getFirst();
        ...
        void getSeries_sortByName_asc() {
            ...
            MobilePageResponse<MobileSeriesSummary> result = service.getSeries(0, 20, "name", "asc", null, null, false);
        ...
        void getSeries_sortByBookCount_desc() {
            ...
            MobilePageResponse<MobileSeriesSummary> result = service.getSeries(0, 20, "bookCount", "desc", null, null, false);
    ...
    class GetSeriesBooksTests {
        ...
        void getSeriesBooks_admin_returnsBooks() {
            ...
            MobilePageResponse<MobileBookSummary> result = service.getSeriesBooks("Dune", 0, 20, null, null, null);
        ...
        void getSeriesBooks_nonAdmin_withAccess_succeeds() {
            ...
            MobilePageResponse<MobileBookSummary> result = service.getSeriesBooks("Dune", 0, 20, null, null, 5L);
        ...
        void getSeriesBooks_emptyResult_returnsEmptyPage() {
            ...
            MobilePageResponse<MobileBookSummary> result = service.getSeriesBooks("Nonexistent", 0, 20, null, null, null);
        ...
        void getSeriesBooks_sortByTitle_desc() {
            ...
            MobilePageResponse<MobileBookSummary> result = service.getSeriesBooks("Dune", 0, 20, "title", "desc", null);
        ...
        void getSeriesBooks_sortByRecentlyAdded_asc() {
            ...
            MobilePageResponse<MobileBookSummary> result = service.getSeriesBooks("Dune", 0, 20, "recentlyAdded", "asc", null);
        ...
        void getSeriesBooks_paginationDefaults() {
            ...
            MobilePageResponse<MobileBookSummary> result = service.getSeriesBooks("Dune", null, null, null, null, null);
        ...
        void getSeriesBooks_pageSizeCapped() {
            ...
            MobilePageResponse<MobileBookSummary> result = service.getSeriesBooks("Dune", 0, 200, null, null, null);
    ...
    private void mockMapperSummary() {
        when(mobileBookMapper.toSummary(any(BookEntity.class), any()))
                .thenAnswer(inv -> {
                    ...
                    return MobileBookSummary.builder()
                            .id(b.getId())
